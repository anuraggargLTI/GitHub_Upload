...
print("Total number of loans are :",number_of_loans)
...
print(f"Total value of the loan is ${total_value_of_loans:.2f}")
...
print(f"Average loan amount is ${average_loan_amount:.2f}")
...
print(f"Future value of the loan amount is ${future_value:.2f}")
remaining_months = loan["remaining_months"]
print(f"Remaining months in the loan amount is {remaining_months}")
